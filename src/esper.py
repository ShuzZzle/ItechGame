...
from typing import List, Type, TypeVar, Dict, Any, Tuple, Iterable, Generator
...
class World:
    ...
    def _get_components(self, *component_types: Type[C]) -> Iterable[Tuple[int, List[C]]]:
        ...
        if len(component_types) == 0:
            raise ValueError("_get_components: Called with no variadic Arguments!")
